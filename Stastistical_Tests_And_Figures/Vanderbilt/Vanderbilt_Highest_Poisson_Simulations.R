...
for(i in (meta_col+1):(ncol(Normalized_myT1))){
  ...
  pValuesSampleType_Normalized_myT1[i-meta_col] <- kruskal$p.value
...
for(i in (meta_col+1):(ncol(Normalized_myT2))){
  ...
  pValuesSampleType_Normalized_myT2[i-meta_col] <- kruskal$p.value
...
ordered_FDR_Normalized_myT1=FDR_Corrected_pValuesSampleType_Normalized_myT1[order(-Normalized_Mean_myT1)]
ordered_FDR_Normalized_myT2=FDR_Corrected_pValuesSampleType_Normalized_myT2[order(-Normalized_Mean_myT2)]
...
pdf(paste("Vanderbilt_Highest_Poisson_Simulated_Spearman_for_Kraken2_at_",input[k],".pdf",sep=""))
...
pdf(paste("Vanderbilt_Highest_Poisson_Simulated_Spearman_for_Metaphlan2_at_",input[k],".pdf",sep=""))
