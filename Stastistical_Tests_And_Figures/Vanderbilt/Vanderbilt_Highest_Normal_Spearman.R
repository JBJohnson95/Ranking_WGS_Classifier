...
for (k in 1:length(input)){
  ...
  pdf(paste("Vanderbilt_Normalized_Kraken2_Highest_Spearman_",input[k],".pdf",sep=""))
  plot(ordered_Normalized_Mean_myT1, maxCors_1,xlab = "Log Mean",
       ylab="Rho",main=paste("Vanderbilt Kraken2 Spearman test at ",input[k],sep=""),ylim=c(-1,1),xlim=c(0,6.5),
  ...
  pdf(paste("Vanderbilt_Normalized_Metaphlan2_Highest_Spearman_",input[k],".pdf",sep=""))
  plot(ordered_Normalized_Mean_myT2, maxCors_2,xlab = "Log Mean",
       ylab="Rho",main=paste("Vanderbilt Metaphlan2 Spearman test at ",input[k],sep=""),ylim=c(-1,1),xlim=c(0,6.5),
