...
for (k in 1:length(input)){
  ...
  pdf(paste("China_Poisson_Simulated_Spearman_for_Kraken2_at_",input[k],".pdf",sep=""))
  ...
  pdf(paste("China_Poisson_Simulated_Spearman_for_Metaphlan2_at_",input[k],".pdf",sep=""))
  ...
  legend("bottom",inset=c(0,max(highest)*.1),c("Insignificant","Significant for Metaphlan2","Simulated Data"),
