...
pdf(paste("China_Highest_Poisson_Simulated_Spearman_for_Kraken2_at_",input[k],".pdf",sep=""))
...
pdf(paste("China_Highest_Poisson_Simulated_Spearman_for_Metaphlan2_at_",input[k],".pdf",sep=""))
