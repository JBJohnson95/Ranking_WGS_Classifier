...
for (k in 1:length(input)){
  ...
  pdf(paste("Pig_Gut_Raw_Normalized_Kraken2_Spearman_",input[k],".pdf",sep=""))
  plot(Original_Order_Normalized_Mean_myT1[2:length(Original_Order_Normalized_Mean_myT1)],highest,xlab = "Log  Mean",
       ylab="Rho",main=paste("Pig Gut Kraken2 Spearman test at ",input[k]," level",sep=""),ylim=c(-1,1),
  ...
  pdf(paste("Pig_Gut_Raw_Normalized_Metaphlan2_Spearman_",input[k],".pdf",sep=""))
  plot(Original_Order_Normalized_Mean_myT2[2:length(Original_Order_Normalized_Mean_myT2)],highest_2,xlab = "Log  Mean",
       ylab="Rho",main=paste("Pig Gut Metaphlan2 Spearman test at ",input[k]," level",sep=""),ylim=c(-1,1),
