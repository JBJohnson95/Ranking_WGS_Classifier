...
for (k in 1:length(input)){
  ...
  pdf(paste("Vanderbilt_Poisson_Simulated_Spearman_for_Kraken2_at_",input[k],".pdf",sep=""))
  plot(Original_Order_Normalized_Mean_myT1[2:length(Original_Order_Normalized_Mean_myT1)],highest,xlab = "Log Mean",
       ylab="Rho",main=paste("Vanderbilt Kraken2 Spearman vs Simulated at ",input[k],sep=""),ylim=c(-1,1),xlim=c(0,6.5),
  ...
  pdf(paste("Vanderbilt_Poisson_Simulated_Spearman_for_Metaphlan2_at_",input[k],".pdf",sep=""))
  plot(Original_Order_Normalized_Mean_myT2[2:length(Original_Order_Normalized_Mean_myT2)],highest_2,xlab = "Log Mean",
       ylab="Rho",main=paste("Vanderbilt Metaphlan2 Spearman vs Simulated at ",input[k],sep=""),ylim=c(-1,1),xlim=c(0,6.5),
